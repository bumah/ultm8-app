...
export const METRICS: Metric[] = [
  ...
  },
  {
    ...
    what: 'Total body weight, often expressed alongside BMI. Best tracked alongside body fat for a fuller picture.',
    ...
    lever: 'Track the trend, not the daily number \u2014 and pair it with body fat for a fuller picture.',
  },
  {
    section: 'health-indicator',
    name: 'Push-ups',
    oneLiner: 'A read on functional strength.',
    what: 'Maximum push-ups in a single set, full range of motion, before failing. Equipment-free, repeatable, and a strong proxy for upper-body strength and endurance.',
    why: 'Higher push-up capacity correlates with better functional strength, lower cardiovascular risk, and slower age-related muscle loss. It\u2019s one of the simplest at-home strength tests with real predictive value.',
    lever: 'Train consistently \u2014 3 sessions a week, push the last set to failure, and progress reps weekly.',
  },
  {
    section: 'health-indicator',
